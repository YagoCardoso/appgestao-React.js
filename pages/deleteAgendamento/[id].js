      ...
      <div>
        ...
        <form className={classes.root}>
               <br></br>
                ...
                <Button  onClick={deletarAgendamento} variant="contained" color="secondary"className={classes.button} startIcon={<DeleteIcon />}> Deletar </Button>
            </form>
          </DialogContent>
      </div>
...
export default DeletAgendamento;